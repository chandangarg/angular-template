...
@Component({
  selector: 'app-courses-card-detail',
  templateUrl: './courses-card-detail.component.html',
  styleUrls: ['./courses-card-detail.component.css']
})
export class CoursesCardDetailComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    console.log(this.id)
    this.course = this.beginnerCourses.filter(item => item.id == this.id)
